                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">List of Admin</h5>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td>
                                        <a href="{{ route('admin.show', $user->id) }}" class="btn btn-primary btn-sm" title="{{ __('Show') }}">
                                            <i class="material-icons">visibility</i>
                                        </a> 
                                        <a href="{{ route('admin.edit', $user->id) }}" class="btn btn-warning btn-sm me-1" title="{{ __('Edit') }}">
